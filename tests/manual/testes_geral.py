...
Executa com:
    python tests/manual/testes_geral.py
...
from utils.config.app_config import get_api_config, get_app_config, get_app_settings
...
from utils.business.vat import describe_vat_choice, get_vat_choice_label
